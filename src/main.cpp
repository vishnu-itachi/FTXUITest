...
// configuration step. It creates a namespace called `FTXUITest`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        FTXUITest::cmake::project_name,
        FTXUITest::cmake::project_version));// version string, acquired
